...
> 关联架构：[0_System/03.tech_architecture.md](../0_System/03.tech_architecture.md)
...
3. 新增 adapter 接口。签名按当前 `soc_sal.h` 实际 API + `03.tech_architecture.md §5.3` 单位口径（mV/mA/mW、功率 `uint32`）统一：
...
| 6 | SoC adapter 化：签名对齐 `03.tech_architecture.md §5.3` 口径 | ISSUE-002 ✅ 已完成（2026-06-29） | 依赖 5 |
