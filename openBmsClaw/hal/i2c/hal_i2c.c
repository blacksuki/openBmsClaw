...
static bool hal_i2c_wait_mask(volatile uint32_t *reg, uint32_t mask, bool set, uint32_t timeout_ms)
{
...
hal_i2c_status_t hal_i2c_write(uint8_t dev_addr, uint8_t reg_addr, const uint8_t *data, uint16_t len, uint32_t timeout_ms)
{
...
hal_i2c_status_t hal_i2c_read(uint8_t dev_addr, uint8_t reg_addr, uint8_t *data, uint16_t len, uint32_t timeout_ms)
{
    volatile uint32_t temp_reg;
