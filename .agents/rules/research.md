...
- **Architecture & System Design**: Refer to `0_System/03.tech_architecture.md` (Strategy/Tech), `0_System/01.project_kickoff_proposal.md` (Project kickoff proposal / origin), and `0_System/10.hardware_software_frame.md` (Core Software/Hardware Architecture).
